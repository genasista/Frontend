  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        ...
        "fixed inset-0 z-50",
        "bg-[var(--dialog-overlay,rgba(0,0,0,0.30))] backdrop-blur-[.5px]",
        className
      )}
      {...props}
    />
    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "fixed top-1/3 left-1/2 z-50 w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2",
          "grid gap-4 rounded-lg border border-border p-6 shadow-none focus-visible:outline-none focus-visible:ring-0",
          "sm:max-w-lg",
          className
        )}
        {...props}
